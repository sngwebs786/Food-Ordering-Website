...
const Cart = () => {
  return (
    <div>
      <Navbar trans="false"/>
      <div class="container mx-auto mt-10" style={{marginTop:"100px"}} >
        <div class="shadow-md my-10 main-div">
          <div class="div1 bg-white px-10 py-10">
          ...
          <div id="summary" class="div2 px-8 py-10">
